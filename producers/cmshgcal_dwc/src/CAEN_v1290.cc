...
int CAEN_V1290::Config(CAEN_V1290_Config_t &_config) {
  GetConfiguration()->baseAddress=_config.baseAddress;    
  GetConfiguration()->model=static_cast<CAEN_V1290_Model_t>(_config.model);
  GetConfiguration()->triggerTimeSubtraction=static_cast<bool>(_config.triggerTimeSubtraction);
  GetConfiguration()->triggerMatchMode=static_cast<bool>(_config.triggerMatchMode);
  GetConfiguration()->emptyEventEnable=static_cast<bool>(_config.emptyEventEnable);
  GetConfiguration()->edgeDetectionMode=static_cast<CAEN_V1290_EdgeDetection_t>(_config.edgeDetectionMode);
  GetConfiguration()->timeResolution=static_cast<CAEN_V1290_TimeResolution_t>(_config.timeResolution);
  GetConfiguration()->maxHitsPerEvent=static_cast<CAEN_V1290_MaxHits_t>(_config.maxHitsPerEvent);
