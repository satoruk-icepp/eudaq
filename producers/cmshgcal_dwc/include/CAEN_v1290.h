...
class CAEN_V1290 {
  public:
    ...
    CAEN_V1290(): handle_(-1) { type_="CAEN_V1290"; id_=0; _isConfigured=false;
      ...
      distrs.push_back(std::normal_distribution<double>(620., 10.));
      distrs.push_back(std::normal_distribution<double>(420., 10.));
      distrs.push_back(std::normal_distribution<double>(670., 10.));
      distrs.push_back(std::normal_distribution<double>(410., 10.));

      distrs.push_back(std::normal_distribution<double>(630., 10.));
      distrs.push_back(std::normal_distribution<double>(430., 10.));
      distrs.push_back(std::normal_distribution<double>(680., 10.));
      distrs.push_back(std::normal_distribution<double>(420., 10.));
    };
    ...
    virtual int Config(CAEN_V1290_Config_t &_config);       //dummy configuration, need to come up with something
